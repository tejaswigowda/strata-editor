function Strings( config ) {
	...
	const values = {
		fa: {
			...
			'menubar/view/showJS': 'Show JS for Selection',
		...
		en: {
			...
			'menubar/git/loading': 'Fetching from GitHub…',
			'menubar/git/committing': 'Pushing to GitHub…',
			...
			'menubar/git/settings/save': 'Save',
			'menubar/git/load/title': 'Load Scene from GitHub',
			'menubar/git/load/confirm': 'Load',
			'menubar/git/load/success': 'Scene loaded ✓',
			'menubar/git/commit/title': 'Commit Scene to GitHub',
			'menubar/git/commit/message': 'Message',
